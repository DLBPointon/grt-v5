...
function makegraph_box() {
    ...
    if (two === 'mipergb') {
        var url = 'http://grit-realtime-api.tol.sanger.ac.ukgritdata?select=manual_interventions,'+three+',length_after'
    } else {
        var url = 'http://grit-realtime-api.tol.sanger.ac.ukgritdata?select='+two+','+three
    }
