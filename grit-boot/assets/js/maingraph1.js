...
function makegraph() {
    ...
    if (two === 'mipergb') {
        var url = 'http://grit-realtime-api.tol.sanger.ac.uk:8001/gritdata?select='+one+',manual_interventions,'+three+',length_after'
            } else {
        var url = 'http://grit-realtime-api.tol.sanger.ac.uk:8001/gritdata?select='+one+','+two+','+three
            }
