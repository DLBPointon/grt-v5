function tabler() {
    ...
    var url = 'http://localhost:3000/gritdata?select=sample_id,prefix_sl,family_name,length_change,scaff_n50_change,scaff_count_change,manual_interventions,date_in_ymd'
